...
function buildAeoPrompt(aeoConfig, persona, product, reviewsSection, promptBlock, variationHint, placeHasReviewImages) {
...
⑤ 붐비는 시간대와 예약 체크 포인트`,
    ...
    if (aeoConfig) {
        ...
        const aeoPromptBlock = enhancedPrompt
            ...
            : "";
        const aeoPrompt = buildAeoPrompt(aeoConfig, persona, product, reviewsSection, aeoPromptBlock, variationHint, placeHasReviewImages);
