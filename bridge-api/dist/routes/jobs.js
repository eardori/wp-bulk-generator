import { createJob, getJob, listJobs, cancelJob, updateJob, appendJobLog, } from "../lib/job-store.js";
...
export async function jobRoutes(app) {
    ...
    app.post("/jobs/content", async (req, reply) => {
        const { productUrl, contentPrompt, product, reviewCollection, siteConfigs, aeoConfig, contentStrategy, autoPublish = true, } = req.body;
